...
public final class file_68 extends JetPage {
  ...
  public void render(final JetPageContext $ctx) throws Throwable {
    ...
    Object responseCode = (Object) context.get("responseCode");
    $out.print($txt_1, $txt_1_bytes);
    $out.print(JetUtils.asEscapeHtml(JetMethods.asString(responseCode))); // line: 2
