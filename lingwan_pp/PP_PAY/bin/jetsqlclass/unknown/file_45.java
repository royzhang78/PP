...
public final class file_45 extends JetPage {
  ...
  private static final String $txt_4 = " where spid=";
  private static final byte[] $txt_4_bytes = JetUtils.asBytes($txt_4, $ENC);
  private static final String $txt_5 = "#spid";
