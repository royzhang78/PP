...
public final class file_1 extends JetPage {
  ...
  private static final String $txt_4 = " and `password`=";
  private static final byte[] $txt_4_bytes = JetUtils.asBytes($txt_4, $ENC);
  private static final String $txt_5 = "#password";
