...
public final class file_12 extends JetPage {
  ...
  public String getName() {
    return "/unknown/file.12";
  }

  public static final String $ENC = "utf-8";
  private static final String $txt_1 = "\n    \tSELECT apk_key,apk_value FROM t_apk_game_param WHERE S_ID=";
  ...
  private static final String $txt_5 = "\n\t\tUNION ALL \n\t\tSELECT apk_key,apk_value FROM t_apk_comm \n    ";
