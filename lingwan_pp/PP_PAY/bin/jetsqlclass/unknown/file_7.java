...
public final class file_7 extends JetPage {
  ...
  public String getName() {
    return "/unknown/file.7";
  }

  public static final String $ENC = "utf-8";
  private static final String $txt_1 = "\n\t\tselect * from sys_pay_config_channel_price_value where f_id=";
  private static final byte[] $txt_1_bytes = JetUtils.asBytes($txt_1, $ENC);
  private static final String $txt_2 = "#f";
