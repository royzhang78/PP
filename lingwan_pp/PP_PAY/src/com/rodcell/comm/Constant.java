...
//	public static List<SysTree> TreeList;
	...
	public static Map SYS_PAY_STATIC_CONFIG = MapsUtil.newHashMap();//静态变量配置信息
	...
	public static String MOresponseStatus="MOresponseStatus";
	public static String MOresponse="MOresponse";
	public static String NotifStatus="NotifStatus";
	public static String unique_key="unique_key";
	public static String NotifResponse="NotifResponse";
	...
	public final static String responseStatus="responseStatus";
	public final static String responseCode="responseCode";
	
	public final static int CALL_SERVER_TYPE0=0;//0为http回调
	public final static int CALL_SERVER_TYPE1=1;//1为不回调
	
	
	public final static int ISSANDBOX_0=0;//正常模式
	public final static int ISSANDBOX_1=1;//沙箱模式
	
	
	public final static int SMS_TYPE=0;//短信支付类型
	
	
	
	public final static String molURL="molURL_";	
	public final static String  molReturnURL="molReturnURL_";
	public final static String  molSecretKey="molSecretKey_";
	public final static String  molAppCode="molAppCode_";
	public final static String  molVersion="molVersion_";
	public final static String  molChannelID="molChannelID_";
	public final static String  moltestURL="moltestURL_";
}
