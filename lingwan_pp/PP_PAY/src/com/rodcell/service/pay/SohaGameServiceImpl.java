 ...
 * 类说明 
 */
@Service(value="sohagameService")
public class SohaGameServiceImpl  implements ApiService{

	private static Logger logger = Logger.getLogger(SohaGameServiceImpl.class);
