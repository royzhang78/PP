 ...
 * 类说明 
 */
@Service(value="PayMainLogService")
public class PayMainLogServiceImpl  implements ApiService{

	private static Logger logger = Logger.getLogger(PayMainLogServiceImpl.class);
