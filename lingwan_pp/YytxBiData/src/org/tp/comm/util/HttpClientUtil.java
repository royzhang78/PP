...
//		System.out.println(HttpClientUtil.post("http://127.0.0.1:8080/foo", data,false));
		String json="{\"callPara\":{\"login_type\":\"2\",\"login_name\":\"868192021251349\",\"u_deviceid\":\"868192021251349\",\"u_releaseChannel\":\"GooglePlay\",\"gameId\":\"GravityAttract-ANDROID-EN\",\"locale\":\"\",\"clientType\":\"\",\"gpsad_id\":\"60dc8407-6529-48d7-a180-1d58c781d4fb\",\"android_id\":\"f6a71d6434e042ac\"},\"serviceName\":\"startGameJson\"}";
		Map p = new HashMap();
		p.put("q", "ee");
		p.put("2", "e2e");
		HttpRequest q =HttpRequest.post("http://127.0.0.1:8083/api").query(p);
		HttpResponse response =  q.send();
		String s = response.bodyText();
