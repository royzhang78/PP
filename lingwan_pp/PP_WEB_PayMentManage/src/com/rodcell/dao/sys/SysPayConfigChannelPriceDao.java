...
//	}
	...
	public int insertsysPayConfigChannelPriceByPrice(Map par)throws SException{
		SqlXML sqlxml = getSql("insertsysPayConfigChannelPriceByPrice",par );
		return this.getDbManagement().update(sqlxml.getSearchsql(), sqlxml.getPar());
	}
	
	
	public int updatesysPayConfigChannelPriceByPrice(Map par)throws SException{
		SqlXML sqlxml = getSql("updatesysPayConfigChannelPriceByPrice",par );
		return this.getDbManagement().update(sqlxml.getSearchsql(), sqlxml.getPar());
	}
