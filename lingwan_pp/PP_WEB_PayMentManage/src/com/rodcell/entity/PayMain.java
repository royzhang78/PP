...
public class PayMain {
	...
	private double amount;//老接口购买的游戏物品数量
	...
	public PayMain(String pay_id, String token, int pay_channel_type,
			int pay_status, String unique_key, double pay_money, String currency,
			...
			String step4, String error_desc,String productType,String cparam,int isSandbox) {
		super();
		this.pay_id = pay_id;
		orderId=this.pay_id;
		this.token = token;
